...
class TestSquareCrossSectionDialogWindow:
    @pytest.fixture
    ...
    def test_get_dialog_data(self, inputtedLength, expectedResultType, expectedResultLength, window, qtbot):
        #Arrage
...
def main():
    TestSquareCrossSectionDialogWindow()
