...
class TestRectangularCrossSectionDialogWindow:
    @pytest.fixture
    ...
    def test_get_dialog_data(self, inputtedWidth, inputtedLength, expectedResultType, expectedResultWidth, expectedResultLength, window, qtbot):
        #Arrage
...
def main():
    TestRectangularCrossSectionDialogWindow()
