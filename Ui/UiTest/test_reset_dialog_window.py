...
def window(qtbot):
    ...
    mmw.user_beam_loads = [("point", 100.0, 0.5)]
...
#     ]
# )
def test_resetBeamLength(window, qtbot):
...
def test_resetSupports(window, qtbot):
...
def test_resetPointLoads(window, qtbot):
...
def test_resetMoments(window, qtbot):
...
def test_resetUDL(window, qtbot):
...
@pytest.mark.skip(reason="functionality to add moments not yet tested")
def test_resetMaterial(window, qtbot):
...
def test_resetCrossSection(window, qtbot):
...
@pytest.mark.skip(reason="functionality to add moments not yet tested")
def test_resetAll(window, qtbot):
...
#@pytest.mark.skip(reason="functionality to add moments not yet tested")
def test_resetSelected(window, qtbot):
