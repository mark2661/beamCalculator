...
class TestAddMomentDialogWindow:
    @pytest.fixture
    def window(self, qtbot):
        window = Add_moment_dialog_window()
        window.show()
    ...
    @pytest.mark.parametrize(
        'direction, inputLoadMagnitudeValue, inputLoadLocation, expectedDirection, expectedLoadMagnitude, expectedLoadLocation, expectedLoadMagnitudeType, expectedLoadLocationType', [
            ('ACW', "100", "100", -1, -100.0, 100.0, float, float), #int input
            ('CW', "100.0", "100.0", 1, 100.0, 100.0, float, float), #float input
            ('ACW', "one hundred", "one hundred", -1, None, None, type(None), type(None)), #string input
            ('CW', "1 hundred", "1 hundred", 1, None, None, type(None), type(None)), #mixed incorrect data type input
            ('ACW', "-100", "100", -1, None, None, type(None), type(None)), # negative magnitude
            ('ACW', "100", "-100", -1, None, None, type(None), type(None)), # negative location
            ('ACW', "", "100", -1, None, None, type(None), type(None)), #empty magnitude input
            ('ACW', "100", "", -1, None, None, type(None), type(None)), #empty load input
            ('ACW', None, None, -1, None, None, type(None), type(None)) # NoneType input
