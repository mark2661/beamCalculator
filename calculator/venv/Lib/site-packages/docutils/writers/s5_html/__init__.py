...
class Writer(html4css1.Writer):
    ...
    settings_spec = html4css1.Writer.settings_spec + (
        ...
        (('Specify an installed S5 theme by name.  Overrides --theme-url.  '
          ...
          'copied into a "uiFiles/<theme>" directory, in the same directory as the '
         ...
         ('Allow existing theme files in the ``uiFiles/<theme>`` directory to be '
          'overwritten.  The default is not to overwrite theme files.',
          ['--overwrite-theme-files'],
          {'action': 'store_true', 'validator': frontend.validate_boolean}),
         ('Keep existing theme files in the ``uiFiles/<theme>`` directory; do not '
...
# <div class="bottomright"></div>
    ...
    def copy_theme(self):
        ...
        self.theme_file_path = '%s/%s' % ('uiFiles', settings.theme)
        if settings._destination:
            dest = os.path.join(
                os.path.dirname(settings._destination), 'uiFiles', settings.theme)
    ...
    def copy_file(self, name, source_dir, dest_dir):
        ...
        if os.path.isfile(source):
            ...
            if os.path.exists(dest) and not settings.overwrite_theme_files:
                ...
                dest_file.write(src_data.replace(b'uiFiles/default',
                    dest_dir[dest_dir.rfind('uiFiles/'):].encode(
