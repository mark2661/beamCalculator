...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.SupportLocationInputField)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Support Type: "))
        self.comboBox.setItemText(0, _translate("Dialog", "Pin Support"))
        self.comboBox.setItemText(1, _translate("Dialog", "Roller Support"))
        self.comboBox.setItemText(2, _translate("Dialog", "Fixed Support"))
